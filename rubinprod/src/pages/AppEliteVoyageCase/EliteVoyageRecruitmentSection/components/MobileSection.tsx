...
import leftRecruit from '../../../../assets/video/eliteVoyage/leftRecruit.mp4'
import middleRecruit from '../../../../assets/video/eliteVoyage/middleRecruit.mp4'
import rightRecruit from '../../../../assets/video/eliteVoyage/rightRecruit.mp4'
                    ...
                    <FlexContainer direction="column" gap="10px">
                        <RevealBlock delay={0.25} blockColor="#b9965a">
                            <StyledShowReel
                                ...
                                playsInline
                            >
                                <source src={leftRecruit} type="video/mp4" />
                    ...
                    <FlexContainer direction="column" gap="10px">
                        <RevealBlock delay={0.25} blockColor="#b9965a">
                            <StyledShowReel
                                ...
                                playsInline
                            >
                                <source src={middleRecruit} type="video/mp4" />
                                Your browser does not support the video tag.
                            </StyledShowReel>
                        </RevealBlock>
                        <Text $paddingOverride="25px" />
                    ...
                    <FlexContainer direction="column" gap="10px">
                        <RevealBlock delay={0.25} blockColor="#b9965a">
                            <StyledShowReel
                                ...
                                playsInline
                            >
                                <source src={rightRecruit} type="video/mp4" />
                                Your browser does not support the video tag.
                            </StyledShowReel>
                        </RevealBlock>
